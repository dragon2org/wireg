...
// Package wireg provides compile-time dependency injection logic as a
// Go library.
package wire
...
func (g *gen) frame(tags string) []byte {
	...
	buf.WriteString("//go:generate go run -mod=mod github.com/dragon2org/wiregg/cmd/wireg" + tags + "\n")
